...
class Retriever:
    ...
    def __init__(self, data_dir="data", subfolder="insights_json", index_filename="questions.index", use_remote=False):
    ...
    def load_questions(self):
        ...
        print(f"✅ Loaded {len(questions)} questions from {self.folder_path}")
        return questions
    ...
    def search(self, query_text, top_k=10, threshold=0.45):
        ...
        for idx, score in zip(I[0], D[0]):
            if idx < len(self.questions) and score > threshold:
                results.append({
